 ...
 */
public class InformeInstructores extends javax.swing.JFrame {

    /**
     * Creates new form InformeInstructores
     */
    public InformeInstructores() {
        initComponents();
        
        tbInfo2.setEnabled(true);
        Informe2 objetoInstructor = new Informe2 ();
        objetoInstructor.MostrarInstructor(tbInfo2);
    }
    ...
    private void initComponents() {
        ...
        tbInfo2.setBackground(new java.awt.Color(255, 255, 102));
        ...
        jScrollPane2.setViewportView(tbInfo2);
        ...
        jLabel1.setText("NUMEROS DE ALUMNOS ASIGNADOS:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InformeInstructores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InformeInstructores().setVisible(true);
            }
        });
    }
